...
## Skill
Always check the `.agent/skills/` directory for available skills. Use the `superpowers-workflow` skill to execute tasks. It is mandatory to use this skill for all tasks.
...
- Use camelCase for all file names, including components, layouts, pages, and store files.
